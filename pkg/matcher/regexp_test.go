...
func TestRegexpMatcher_Prefilter_WithKeywords(t *testing.T) {
	rules := []*types.Rule{
		{
			ID:           "test.1",
			Name:         "AWS Key",
...
func TestRegexpMatcher_Prefilter_NoKeywordsAlwaysRun(t *testing.T) {
	rules := []*types.Rule{
		{
			ID:           "test.1",
			Name:         "AWS Key",
...
func TestRegexpMatcher_Prefilter_NoMatchingKeywords(t *testing.T) {
	rules := []*types.Rule{
		{
			ID:           "test.1",
			Name:         "AWS Key",
