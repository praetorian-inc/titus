...
var enumCmd = &cobra.Command{
	...
	Long: `Enumerate remote services (GitHub, GitLab, Slack, Notion, Linear, Confluence, Jira, Microsoft 365, ServiceNow, Zendesk, Trello, Discord)
...
func init() {
	...
	enumCmd.AddCommand(githubCmd, gitlabCmd, slackCmd, notionCmd, linearCmd, confluenceCmd, jiraCmd, microsoftCmd, gdriveCmd, servicenowCmd, zendeskCmd, trelloCmd, discordCmd)
}
